...
Token = 'OTQ3OTYzMzMyMDcyMTkwMDEy.GX2ix4.VrHGWkuBN5cwIKrKxW4y00qsfEBwPtAOqM7hys'
bot_version_info = "Running on Version 2.0"
...
async def on_ready():
    ...
    check_active_file(331786221095354370)
